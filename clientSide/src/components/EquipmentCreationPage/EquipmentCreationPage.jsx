  ...
  const testConnection = async () => {
    try {
      const response = await axios.get(
        ...
        {
          withCredentials: true,
          params: { limit: 1 }, // طلب عنصر واحد فقط للتحقق من الاتصال
        }
      );

      console.log("اختبار الاتصال:", response);
      toast.success("تم الاتصال بالخادم بنجاح!");
    } catch (error) {
      console.error("خطأ في اختبار الاتصال:", error);
      toast.error(`فشل الاتصال: ${error.message || "خطأ غير معروف"}`);
    }
  };
        ...
        <div className="border rounded-lg p-8 shadow-sm bg-white">
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  } rounded-md p-2 text-right focus:outline-none focus:ring-2 focus:ring-amber-500`}
              ...
              <div>
                ...
                >
                  ...
                  <option value="معدات طرق">معدات طرق</option>
                  <option value="مولدات">مولدات</option>
                  <option value="كمبروسرات">كمبروسرات</option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="features"
                  className="w-full border border-gray-300 rounded-md p-2 text-right focus:outline-none focus:ring-2 focus:ring-amber-500"
            ...
            <div className="mt-4 border-t pt-4">
              <button
                ...
                onClick={() => {
                  ...
                  toast.info("تم عرض بيانات النموذج في وحدة التحكم (Console)");
                }}
                className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md mr-2 text-sm"
              >
                فحص البيانات
              </button>
            </div>
            ...
            <button
              ...
              type="button"
              disabled={loading}
              className="bg-amber-500 hover:bg-amber-600 text-white px-10 py-2 rounded-md font-medium mt-4 transition duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              التالي
            </button>
          </form>
        ...
        <div className="border rounded-lg p-8 shadow-sm bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="text-lg font-medium text-gray-700 mb-4 text-right flex items-center justify-end gap-2">
            ...
            <div className="flex justify-between mt-6">
              <button
                type="button"
                onClick={prevStep}
                className="bg-gray-500 hover:bg-gray-600 text-white px-10 py-2 rounded-md font-medium transition duration-200"
                disabled={loading}
              >
                الرجوع
              </button>
              ...
              <button
                type="submit"
                className="bg-amber-500 hover:bg-amber-600 text-white px-10 py-2 rounded-md font-medium transition duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed"
                disabled={loading}
              >
