...
// import { Wrench , Truck, Upload, Building, FileCheck, MapPin, Phone, Info } from "lucide-react";
...
//       toast.success("تم إرسال طلب الانضمام بنجاح، سيتم مراجعته والرد في أقرب وقت");
...
//         <span className="mr-4 text-gray-700 text-xl">جاري التحميل...</span>
//       </div>
//     );
//   }
...
//             {/* Header Section */}
//             <div className="bg-gradient-to-r from-amber-500 to-amber-600 px-6 py-8 text-center md:text-right">
...
//                     <Truck className="h-12 w-12 text-amber-500 mt-1" />
//                   </div>
//                 </div>
...
//                   <Info className="ml-2 h-5 w-5 text-amber-500" />
//                   معلوماتك الحالية
//                 </h2>
...
//               <div>
//                 <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
//                   <Building className="ml-2 h-5 w-5 text-amber-500" />
//                   معلومات الشريك
//                 </h2>
//                 <form onSubmit={handleSubmit} className="space-y-6">
//                   {/* Business Type */}
//                   <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
//                     <label className="font-medium text-gray-700 block mb-2">نوع العمل</label>
...
//                           className="ml-2 h-4 w-4 text-amber-500 focus:ring-amber-500"
//                         />
...
//                         {formData.businessType === "company" ? "اسم الشركة" : "الاسم التجاري (اختياري)"}
//                       </label>
//                       <input
//                         type="text"
//                         name="companyName"
...
//                         placeholder={formData.businessType === "company" ? "اسم الشركة / المؤسسة" : "الاسم التجاري إن وجد"}
...
//                           onChange={handleInputChange}
//                           className="w-full p-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
...
//                       <FileCheck className="ml-2 h-5 w-5 text-amber-500" />
//                       المستندات المطلوبة
//                     </label>
...
//                         المستندات المقبولة: JPG، PNG، PDF (الحد الأقصى 5 ميجابايت)
//                       </p>
//                     </div>
...
//                           </label>
//                           <span className="mr-3 text-sm text-gray-500">
//                             {commercialRegister ? commercialRegister.name : "لم يتم اختيار ملف"}
//                           </span>
//                         </div>
//                       </div>
//                     )}
...
//                         className="mt-1 ml-2 h-4 w-4 text-amber-500 focus:ring-amber-500"
//                         required
//                       />
//                       <span className="text-sm text-gray-600">
//                         أوافق على <a href="/terms" className="text-amber-500 hover:underline">الشروط والأحكام</a> الخاصة بالانضمام كشريك في منصة المعدات الذهبية وأقر بأن جميع المعلومات المقدمة صحيحة ودقيقة.
//                       </span>
//                     </label>
//                   </div>
...
//                     <button
//                       type="submit"
//                       className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-md transition-colors duration-300 flex items-center"
//                     >
...
//             <h2 className="text-xl font-bold text-gray-800 mb-6 text-center">مميزات الانضمام كشريك</h2>
...
//                   </svg>
//                 </div>
//                 <h3 className="font-bold text-gray-800 mb-2">زيادة الدخل</h3>
//                 <p className="text-gray-600 text-sm">
//                   إمكانية تحقيق دخل إضافي من خلال تأجير معداتك في أوقات عدم استخدامها
//                 </p>
//               </div>
...
//                   </svg>
//                 </div>
//                 <h3 className="font-bold text-gray-800 mb-2">توسيع نطاق الأعمال</h3>
//                 <p className="text-gray-600 text-sm">
//                   الوصول إلى قاعدة عملاء أوسع والحصول على فرص عمل جديدة في مختلف المناطق
//                 </p>
//               </div>
...
//                   </svg>
//                 </div>
//                 <h3 className="font-bold text-gray-800 mb-2">منصة آمنة وموثوقة</h3>
//                 <p className="text-gray-600 text-sm">
